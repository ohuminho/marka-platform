-- MARKA Mobility Financial Core Bridge
--
-- Links the Mobility commercial settlement with the
-- authoritative MARKA Financial Core transactions.
--
-- MobilitySettlement remains the Mobility commercial
-- lifecycle record.
--
-- Financial Core remains the accounting source of truth.
